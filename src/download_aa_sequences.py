...
def convert_bnumbers_to_UPID(bnumbers_list, ecoli_gene_list_fname):
    dictionary = {}
    bnumber_to_UPID = {}    
    for row in open(ecoli_gene_list_fname, 'r'):
        dictionary[row[0:5]] = row[48:54]
    for b in bnumbers_list:
        bnumber_to_UPID[b] = dictionary[b]
    return bnumber_to_UPID.values()
